...
Image("/kaggle/input/metric/Metric.png")
from sklearn.metrics import mean_squared_log_error

#np.sqrt(mean_squared_log_error( y_test, predictions ))
air_r = pd.read_csv('/kaggle/input/recruit-restaurant-visitor-forecasting/air_reserve.csv.zip')
...
ss = pd.read_csv('/kaggle/input/recruit-restaurant-visitor-forecasting/sample_submission.csv.zip')
ss.shape
