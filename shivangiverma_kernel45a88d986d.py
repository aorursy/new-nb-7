...
df.rename(columns={'Id':'ForecastId'},inplace=True)
...
dfa=pd.read_csv("/kaggle/input/covid19-global-forecasting-week-1/test.csv")  
...
X_train, X_test, y_train, y_test = train_test_split(x, y, test_size=12212, random_state=1)
X_test.count
from sklearn.tree import DecisionTreeRegressor  
...
datab.count
datab.to_csv('submission.csv',index=False)