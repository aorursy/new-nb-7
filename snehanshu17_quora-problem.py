...
train_df["num_words_unique"]=train_df["question_text"].apply(lambda x:len(set(str(x).split())))
test_df["num_words_unique"]=test_df["question_text"].apply(lambda x:len(set(str(x).split())))
