...
for i in range(7):
    ...
    train_ad_sample_df = train_df['acoustic_data'].values[6291455*i:6291455*(i+1)]

    train_ttf_sample_df = train_df['time_to_failure'].values[6291455*i:6291455*(i+1)]
...
for fold_, (trn_idx, val_idx) in enumerate(folds.split(scaled_train_X,train_y.values)):
    ...
    model = lgb.LGBMRegressor(**paramsNoneOver, n_estimators = 20000, n_jobs = -1)
...
scaled_test_X.to_csv('scaled_test_x',index=False)

scaled_train_X.to_csv('scaled_train_x',index=False)
